...
--Command     : generate_target fft_8192_1c_core_bd_wrapper.bd
--Design      : fft_8192_1c_core_bd_wrapper
...
entity fft_8192_1c_core_bd_wrapper is
  port (
    clk : in STD_LOGIC;
...
end fft_8192_1c_core_bd_wrapper;

architecture STRUCTURE of fft_8192_1c_core_bd_wrapper is
  component fft_8192_1c_core_bd is
  port (
    clk : in STD_LOGIC;
    out0 : out STD_LOGIC_VECTOR ( 35 downto 0 );
    out1 : out STD_LOGIC_VECTOR ( 35 downto 0 );
  ...
  end component fft_8192_1c_core_bd;
begin
fft_8192_1c_core_bd_i: component fft_8192_1c_core_bd
     port map (
      clk => clk,
